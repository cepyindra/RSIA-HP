<div class="container-fluid">
  ...
  <table align="center" class="table table-hover table-bordered">
    ...
    <tr>
        ...
        <th class="active col-sm-1">NIP</th>
        <th class="active col-sm-2">Nama Dokter</th>
        <th class="active col-sm-1">Spesialisasi</th>
        <th class="active col-sm-1">Jabatan</th>
        <th class="active col-sm-2">Tanggal Lahir</th>
        <th class="active col-sm-2">Alamat</th>
        <th class="active col-sm-2">Nomor Telepon</th>
        <th class="active col-sm-1">Status</th>
    ...
    <?php
      ...
      foreach ($sql1->result() as $obj1) {
          ...
          <tr>
            ...
            <td><?php echo $obj1->spesialisasi; ?></td>
            <td><?php echo $obj1->jabatan; ?></td>
