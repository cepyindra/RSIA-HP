...
<html lang="en">
  <head>
    ...
    <title>Database RSIA Humana Prima</title>

    <!-- Bootstrap -->
    <link href="<?php echo base_url(); ?>assets/bootstrap-3.3.5-dist/css/bootstrap.css" rel="stylesheet">
  ...
  <nav class="navbar navbar-inverse navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">RSIA Humana Prima</a>
      </div>
